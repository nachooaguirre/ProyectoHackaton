...
const recommendations_controller_js_1 = require("./recommendations.controller.js");
...
exports.RecommendationsModule = RecommendationsModule = __decorate([
    (0, common_1.Module)({
        controllers: [recommendations_controller_js_1.RecommendationsController],
        providers: [recommendations_service_js_1.RecommendationsService],
    })
